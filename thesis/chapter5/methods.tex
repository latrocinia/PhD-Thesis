...
\intable[tab:RPII-crosslinks]. The input files are included in the DisVis
source code. 
...
number of cross-links is shown in \intable[tab:RPII-accessible-complexes-fine]
and \in[tab:RPII-accessible-complexes-coarse], and the relative occurrence of
restraint violations in Table S3 and S5 for the fine and coarse run,
respectively.
...
were set to 23 and 26\Angstrom, respectively, since 95\% of all found distances
in a benchmark were smaller. All input files are included in the DisVis source
code. 
...
in Table S7 and S9, and their normalized restraint violation occurrence in
Table S8 and S10. 
