...
from \citeauthor{Leitner2014} Dataset S1 (Table S6), which consist of 4 ADH and
3 zero-length ZL cross-links. The maximum ADH- and ZL-linker length were set to
23 and 26\Angstrom, respectively, since 95\% of all found distances in a
benchmark were smaller. All input files are included in the DisVis source code. 
