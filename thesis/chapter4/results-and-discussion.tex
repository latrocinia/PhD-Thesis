...
proteins of the 30S E. coli ribosome using a 9.8\Angstrom\ cryo-EM map (EMD-1884).  The
...
placed in the density (\infigure[fig:1884-results]{A}). Applying HADDOCK-EM
...
1.56\Angstrom\ compared to the crystal structure (\infigure[fig:1884-results]{B}).
