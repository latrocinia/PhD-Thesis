...
complete shapes, though with low-resolution \cite[Kock2003, Putnam2007,
...
this effect, the sample is typically plunge-frozen in liquid ethanol to
...
\startsubsubsubject[title=Rosetta]
...
\startsubsubsubject[title=HADDOCK]
...
\cite[vanDijk2005], relaxation anisotropy \cite[vanDijk2006], protein-DNA
docking \cite[vanDijk2006], solvated docking using explicit water
...
and NMR System) for its computational backend \cite[Brunger2007]. 
...
different paradigm and associated field as “explorative modeling”. A hallmark
