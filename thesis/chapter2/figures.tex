\useexternalfigure[fig:core-index_resampling-trimming][Figure1]
...
\useexternalfigure[fig:powerfit-flowchart][Figure2]
\startbuffer[cap:powerfit-flowchart]
\caption{Flowchart of the powerfit algorithm.}{}
\stopbuffer


\useexternalfigure[fig:ribosome-results][Figure3]
...
\useexternalfigure[fig:GroEL-GroES][Figure4]
...
\useexternalfigure[fig:additional-cases][Figure5]
