...
\caption{Algorithms used in PowerFit.}{(A) Illustration of the calculation of the core-weighted mask. The
...
each square consist of \m{8 \times 8} voxels. After resampling and trimming the
