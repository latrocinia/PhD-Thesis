...
\setuphead[chapter][indentnext=no]
...
\definehead[BackmatterHead][chapter][style=style:chapter, number=no, page=yes]
% section level
...
% Chapter head
\setuphead[Chapter][command=\MyChapter, style=style:chapter,
    indentnext=no, before={\blank[5em, force]}, after={\blank[4em]}]
