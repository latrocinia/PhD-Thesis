...
\setuphead[Chapter][command=\MyChapter, style=\tfb\bf,
...
\setuphead[Subsubsection][number=no, incrementnumber=no, style=style:subsubsection]

% unnumber sections
\definehead[Subject][Section]
\definehead[Subsubject][Subsection]
\setuphead[Subject][number=no, incrementnumber=no]
\setuphead[Subsubject][number=no, incrementnumber=no]
